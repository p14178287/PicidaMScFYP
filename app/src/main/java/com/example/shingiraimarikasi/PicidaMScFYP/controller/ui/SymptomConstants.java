...
//
//import com.example.shingiraimarikasi.PicidaMScFYP.BuildConfig;

public class SymptomConstants {
//    public static final String BETTER_DOCTOR_CONSUMER_KEY = BuildConfig.R.BETTER_DOCTOR_CONSUMER_KEY;
...
//    public static final String FIREBASE_CHILD_DOCTORS = "doctors";
    public static final String FIREBASE_CHILD_SYMPTOM = "symptom";
