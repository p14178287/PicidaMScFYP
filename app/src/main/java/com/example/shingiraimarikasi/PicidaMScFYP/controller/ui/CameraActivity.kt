...
//import permissions.dispatcher.R
...
class CameraPreviewFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater,
            ...
            inflater.inflate(R.layout.activity_navigation, null)

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        val button: Button? = view.findViewById(R.id.nav_camera)
    ...
    private fun initCamera() {
        camera = getCameraInstance(CAMERA_ID)?.also { camera ->
            ...
            val previewFrameLayout: FrameLayout? = view?.findViewById(R.id.nav_camera)
